...
void cpu_op_1485a(t_ipc *ipc) /* ASR */ {
  ...
  uint8_t bits = 8;
  uint8_t count = srcdata & 63;
  uint8_t outdata = ((int8_t)dstdata) >> (count > 7 ? 7 : count);
...
void cpu_op_1486a(t_ipc *ipc) /* ASR */ {
  ...
  uint8_t bits = 16;
  uint8_t count = srcdata & 63;
  uint16_t outdata = ((int16_t)dstdata) >> (count > 15 ? 15 : count);
...
void cpu_op_1487a(t_ipc *ipc) /* ASR */ {
  ...
  uint8_t bits = 32;
  uint8_t count = srcdata & 63;
  uint32_t outdata = ((int32_t)dstdata) >> (count > 31 ? 31 : count);
...
void cpu_op_1488a(t_ipc *ipc) /* LSR */ {
  ...
  uint8_t bits = 8;
  uint8_t count = srcdata & 63;
  uint8_t outdata = dstdata >> (count > (bits-1) ? (bits-1) : count);
...
void cpu_op_1489a(t_ipc *ipc) /* LSR */ {
  ...
  uint8_t bits = 16;
  uint8_t count = srcdata & 63;
  uint16_t outdata = dstdata >> (count > (bits-1) ? (bits-1) : count);
...
void cpu_op_1490a(t_ipc *ipc) /* LSR */ {
  ...
  uint8_t bits = 32;
  uint8_t count = srcdata & 63;
  uint32_t outdata = dstdata >> (count > (bits-1) ? (bits-1) : count);
...
void cpu_op_1521a(t_ipc *ipc) /* ASL */ {
  ...
  uint8_t bits = 8;
  uint8_t count = srcdata & 63;
  uint8_t outdata = count >= bits ? 0 : (dstdata << count);
...
void cpu_op_1522a(t_ipc *ipc) /* ASL */ {
  ...
  uint8_t bits = 16;
  uint8_t count = srcdata & 63;
  uint16_t outdata = count >= bits ? 0 : (dstdata << count);
...
void cpu_op_1523a(t_ipc *ipc) /* ASL */ {
  ...
  uint8_t bits = 32;
  uint8_t count = srcdata & 63;
  uint32_t outdata = count >= bits ? 0 : (dstdata << count);
...
void cpu_op_1523b(t_ipc *ipc) /* ASL */ {
  ...
  if (!count)
    ...
    XFLAG = dstdata>>(bits-count) & 1;
    {
      uint32_t mask = 0xffffffff <<(31-count);
      VFLAG = ((dstdata & mask) != mask) && ((dstdata & mask) != 0);
    }
  }
  NFLAG = ((int32_t)outdata) < 0;
